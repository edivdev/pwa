...
const MainSlider = () => {
  ...
  return (
    <Flex py={isMobile ? '5%' : 'none'} backgroundImage="/images/static/backgrounds/BLUE_BACKGROUND.jpg" backgroundSize="cover" w="100vw" flexDirection={isMobile ? 'column' : 'row'}>
      <Box w={isMobile ? "100vw" : "50vw"} px="6%">
