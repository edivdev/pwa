...
export const goals = [
  { id: 1, title: `Children's Rights`, goal: `Our Children's Rights Department is all about children's voices being heard. We are teaching children about their rights and how to exercise them. We are creating a platform for young people to share content about their rights and to enable them to build their own collective to share ideas.`, pic: 'cr.png' },
  { id: 2, title: `Sexual & Reproductive Health`, goal: `Our resident Dr Diversa opens the dialogue to answer questions that young people may be ashamed to ask but are extremely common. We share information regarding healthy sexual development to help young people understand their own bodies and keeping healthy and safe.`, pic: 'srh.png' },
  { id: 3, title: `Legal & Research`, goal: `Our Legal & Research department facilitates the sharing of academic articles to ensure that people who may not be able to afford to access journals and other publications have access to important reference materials to use in informing their studies. They also work to showcase law reform around the world relating to the objectives.`, pic: 'legal.png' },
  { id: 4, title: `Inclusion`, goal: `Our Inclusion department focuses on showcasing diversity in all aspects of life. Through embedding inclusive practices in classrooms from a young age we aim to eliminate stigmas surrounding difference and ensure each persons individuality and uniqueness are celebrated.`, pic: 'inclusion.png' },
  { id: 5, title: `Women's Rights`, goal: 'Our womens rights department is dedicated to engaging men to lead the fight to eliminate gender-based violence. We are raising awareness of the global problem of Femicide through preserving the memories of victims and making thier stories known.', pic: 'wr.png' },
  { id: 6, title: `Eliminating Violence & Peaceful Conflict Resolution`, goal: `We advocate for eliminating violence and peaceful conflict resolution in the hope of eliminating violence in the world. Starting young, we are educating children about the effects of bullying and the promotion of wellbeing activities to nurture the mental health of people.`, pic: 'agbv.png' },
  { id: 7, title: `Art`, goal: `Art is at the centre of Educacion diversa. It is accessible to all, displaying clear universal messages. Art and creativity is also proven to have therapeutic benefits and has a positive impact on the development of the neurological pathways in the brain which supports positive mental wellbeing.`, pic: 'art.png' },
  { id: 8, title: `Sustainability`, goal: `Our sustainability department aims to educate children around the world about SDGs, circular economies and biodiversity to help them to appreciate the world we live in and enable them to make informed decisions to protect their environment.`, pic: 'sus.png' }
]

// export const goals = [
//   { id: 1, title: ``, goal: 'Educate children and adolescents about important topics to enable them to navigate and be part of healthy, safe and respectful relationships in society.', pic: 'cr.png' },
//   { id: 2, title: ``, goal: 'Reduce child sexual abuse, adolescent unplanned pregnancies, STIs and HIV in underdeveloped countries by providing access to good quality sexual and reproductive health education resources that are fun and engaging.', pic: 'srh.png' },
//   { id: 3, title: ``, goal: 'Influence changes in government policies across the world by teaching children about their rights and equipping them with the skills to campaign for change to their local leaders.', pic: 'legal.png' },
//   { id: 4, title: ``, goal: 'Create inclusive societies by educating people about the importance of diversity and equality and the benefits of inclusive environments.', pic: 'inclusion.png' },
//   { id: 5, title: `Women's Rights Department`, goal: 'Advocate for the elimination of violence against women by providing free education programmes and resources and raising awareness through digital campaigns across the world.', pic: 'wr.png' },
//   { id: 6, title: ``, goal: 'Promote peaceful conflict resolution by giving free information and activity sheets that support teaching well-being, mindfullness and self-care for people living in communities where conflict has been normalised.', pic: 'agbv.png' },
//   { id: 7, title: ``, goal: 'Engage people to engage in diverse topics using art to ensure our materials are inclusive and accessible to as many people as possble, regardless of socio-economic status or academic ability.', pic: 'art.png' },
//   { id: 8, title: ``, goal: 'Contribute to the Sustainable Development Goals by providing age appropriate educational information and activities to gain interest about them from children earlier with the hope that they are able to take the action needed to save our planet!', pic: 'sus.png' }
// ]