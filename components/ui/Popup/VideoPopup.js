...
export default function VideoPopup({ isPopupShowing, closePopUp, popupInfo, isMobile }) {

  return (
    <Box className="modal" display={isPopupShowing ? 'flex' : 'none'} onClick={closePopUp}>
      <Flex className="" display="flex" w="654px" h="452px" flexDirection={isMobile ? "column" : "row"}>
