        ...
        <Flex flexDirection={isMobile ? "column" : "row"}>
          <Box w={isMobile ? "100%" : "50%"} p="5%">
            ...
            <List py="20px">
              ...
              <ListItem color="white" mb="8px"><Text variant="normal" color="white"><span style={{ marginRight: '6px' }}>✅ </span>Helping Educacion Diversa Inc. in continue to create volunteering opportunities for people all over the world, creating a global network of connected volunteers with the same vision to work together.</Text></ListItem>
              ...
              <ListItem color="white" mb="8px"><Text variant="normal" color="white"><span style={{ marginRight: '6px' }}>✅ </span>A Womens and Girls Empowerment digital colouring in book when they are launched later this year.</Text></ListItem>
              <ListItem color="white" mb="8px"><Text variant="normal" color="white"><span style={{ marginRight: '6px' }}>✅ </span>Free access to the Learning Platform when it launches in 2023.</Text></ListItem>
            </List>
