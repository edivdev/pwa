  ...
  return (
    <Box bg={theme.colors.main.darkblue}>
      <Flex flexDirection={isMobile ? "column" : "row"} py="20px">
        <Box
          w={isMobile ? "100%" : "50%"}
          h={isMobile ? "300px" : "80vh"}
          position="relative"
        >
          <Image
            src="/images/static/about/be_a_volunteer.png"
            layout="fill"
            alt="be a volunteer"
            objectFit="contain"
          />
        ...
        >
          ...
          <Text color="white" fontSize="24px">
            Just fill in the details below and one of our team members will be
            in touch!
          </Text>
          ...
          <Text my="10px" fontSize="13px" color="white">
            * Required fields
          </Text>
