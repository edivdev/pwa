...
export default function Recognition() {
  ...
  return (
    <Flex my={isMobile ? "10%" : "80px"} flexDirection={isMobile ? "column" : "row"}>
      <Flex w={isMobile ? "100%" : "50%"} flexDirection="column" alignItems="center" px="8%">
        <Box>
      ...
      <Box w={isMobile ? "100%" : "50%"}>
        <Box position="relative" w={isMobile ? "80%" : "498px"} h="328px" m="auto" >
