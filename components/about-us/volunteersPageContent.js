...
export default function VolunteersPageContent({ volunteers }) {
  ...
  <br/><br/>Browse through our wonderful volunteers and get to know the people who keep our organisation running.<br/><br/>Follow us on social media to see what some of our past and current volunteers have to say about their experiences working with us`;
  ...
  return (
    <>
      ...
      >
        <Image
          src="/images/static/volunteers/volunteersmap.jpg"
          layout="fill"
          objectFit="contain"
          alt="map"
        />
