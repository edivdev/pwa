      ...
      <Box my="5%" mx={isMobile ? "4%" : "8%"} textAlign="justify">
        <Box className="donate-block">
          <p>
            ...
            and communities in underdeveloped countries. More specifically, the
            organization provides free art-based diverse education in three
            areas: human rights, elimination of violence and bullying, and
          ...
          <p>
            We need your help to finance the operations of the organisation and
            fund projects like the development of our learning platform and also
            small financial scholarships for people in need of opportunities and
            income. Lower socio-economic community foundations and organisations
            will always have access to this platform for FREE and we hope that
            the education provided via the platform will contribute to equality
            in education and the information that people need to make good
            decisions about their lives and bodies. By becoming a member of
            Educacion Diversa, you can be part of this journey and help us help
            others. Lastly, we hope to build the learning platform with a group
            of women who are undergraduate coders from underdeveloped countries,
            in order for them to learn as well as contribute to this bigger
            thing in itself.
          </p>
          <h2>Why should you contribute</h2>
          <p>
            One thing our end users have in common is having each other, and the
            power of learning is in the power of people too. You can actually
            empower these kids through education. They just needed someone to
            believe in them and give them opportunities.
          </p>
          <p>
            We believe with education we can make a difference and we would like
          ...
          <p>
            Becoming a member of Educacion Diversa Inc. gives you the chance to
            contribute to the on-going financial sustainability and operations
            of the organisation, projects, campaigns and the development of
            educational packages in the areas of diverse topics. You also are
            given the chance to participate in the strategic decision-making
            process of Educacion Diversa Inc and you will be able to nominate
            yourself or other qualified members to fill any vacancies advertised
            in the Board of Directors. Your membership contribution also will
            help to create small scholarship opportunities for academics and
            adolescents from underdeveloped countries to ensure they also have
            access to opportunities to gain experience in their sector but also
            to ensure they can be paid for their contribution, as they really do
            need it to break the cycle of poverty. Lastly, any surplus funding
            received will be used to fund the development of learning resources
            to support our educational activities on the ground.
          </p>
        </Box>
      </Box>

      <Box display="flex" justifyContent="space-evenly">
        <Box p="2em 0 3em 0" w={isMobile ? "90%" : "55%"}>
          <Text fontSize="22px" textAlign="center" fontWeight="600">
            If you want to make a donation and/or collaborate with us please
            contact us using the contact form on{" "}
            <Link href="/contact">
              <a>
